...
import { apiHook, payloadMutation, noPayloadMutation, noPayloadStream } from '../helpers';
...
export const jamHooks = (client: OpenpeepsClient) => ({
    ...
    useJamState: (id: string) => apiHook(client.jams.state, { pathParams: { id }, refetchInterval: 1500 }),
