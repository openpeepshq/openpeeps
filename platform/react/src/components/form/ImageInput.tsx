...
export function ImageInput({
  ...
  if (isAvatar) {
    return (
      <div className={`relative size-24 ${className ?? ''}`}>
        ...
        {loading ? (
          <span className="bg-surface/80 absolute inset-0 z-20 flex items-center justify-center rounded-full">
  ...
  return (
    ...
    >
      ...
      {loading ? (
        <span className="bg-surface/80 absolute inset-0 z-20 flex items-center justify-center">
