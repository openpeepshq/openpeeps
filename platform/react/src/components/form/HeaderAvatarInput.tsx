        ...
        >
          {avatar ? (
            <img
              src={avatar}
              alt=""
              className="size-24 rounded-md border-4 border-background object-cover"
            />
          ) : (
            <div className="bg-surface-100 text-muted-foreground flex size-24 items-center justify-center rounded-md border-4 border-background text-2xl font-medium">
              ?
            </div>
          )}
