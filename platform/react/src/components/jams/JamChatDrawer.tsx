...
export function JamChatDrawer({ open, onClose, readOnly = false }: JamChatDrawerProps) {
  const t = useT();
  ...
  return (
    <div
      className={
        'bg-surface-100 absolute top-0 right-0 flex h-full w-full flex-col gap-3 overflow-hidden rounded md:relative md:w-80'
      }
    >
