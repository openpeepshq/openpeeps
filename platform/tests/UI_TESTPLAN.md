...
| ID         | Interaction                        | Preconditions        | Expected                         | Notes        |
| ---------- | ---------------------------------- | -------------------- | -------------------------------- | ------------ |
| UI-AUTH-01 | Login with valid email/password    | seeded account       | Lands on feed or `?redirect=`    | empty/forms  |
| UI-AUTH-02 | Login with bad password            | seeded account       | Error, stay on login             | empty/forms  |
...
| UI-AUTH-11 | Accept privacy checkbox required   | register form        | Submit blocked until checked     | empty/forms  |
...
| UI-ADM-27 | Community: info / language / theme save                      | config update        | Persists                   | empty/forms (info)  |
| UI-ADM-28 | Community: favicons / profile fields / about / CoC / welcome | config update        | Persists                   |                     |
| UI-ADM-29 | Community: roles / links / welcome email / welcome page      | config update        | Persists                   | empty/forms (links) |
...
| ---------------------------------------- | ------------------------------------------------ |
| Auth login/register                      | `empty/forms`, `empty/ui`, `empty/auth/register` |
