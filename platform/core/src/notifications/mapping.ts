import { DbNotification, Notification, NotificationData } from "@openpeeps/common/types";
import { map } from "@openpeeps/arango-querybuilder";
import { postsMapping } from "../posts/mapping";

export const unexpandedNotificationsMapping = map<NotificationData, Notification>({
