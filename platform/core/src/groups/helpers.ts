import type { GroupRoleData, GroupWithMeta, ProfileWithMeta, PublicProfile } from "@openpeeps/common/types";
...
export const addMember = connector<PublicProfile, GroupWithMeta, GroupRoleData>(collectionInfos.profilesCollection, collectionInfos.groupsCollection, collectionInfos.userGroupsCollection);
export const removeMember = disconnector<PublicProfile, GroupWithMeta>(collectionInfos.profilesCollection, collectionInfos.groupsCollection, collectionInfos.userGroupsCollection);
export const updateMember = connectionUpdater<PublicProfile, GroupWithMeta, GroupRoleData>(collectionInfos.profilesCollection, collectionInfos.groupsCollection, collectionInfos.userGroupsCollection);
