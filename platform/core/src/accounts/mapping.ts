...
import { AccountData, AccountWithMeta, ProfileWithMeta, PushSubscription } from "@openpeeps/common/types";
...
export const pushSubscriptionsRelation: RelationWithMapping<PushSubscription> = {
    ...
    direction: 'OUTBOUND',
    skipEdge: true,
    mapping: pushSubscriptionsMapping.removeRelation((r) => r.edgeCollection === 'accountToPushSubscription').data(),
    cardinality: 'many',
};
