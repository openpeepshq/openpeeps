...
import addModeratorMemberManagementCapabilities from './migrations/202607221104-add-moderator-member-management-capabilities';
...
export const dataMigrations = [
  ...
  addModeratorMemberManagementCapabilities,
];
