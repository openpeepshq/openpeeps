...
1. Under **Add provider**, choose a built-in type or **OIDC Generic**.
2. Fill in the fields for that type. Built-in types fill endpoint URLs,
   scopes, and claim mapping from templates when you save.
