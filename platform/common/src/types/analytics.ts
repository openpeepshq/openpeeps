...
export const analyticsOverviewSchema = z.object({
  ...
  metrics: z.object({
    ...
    jamSessions: analyticsMetricCardSchema,
    jamParticipants: analyticsMetricCardSchema,
    replies: analyticsMetricCardSchema,
    interactions: analyticsMetricCardSchema,
    allTimeJamSessions: analyticsMetricCardSchema,
    allTimeJamParticipants: analyticsMetricCardSchema,
    allTimeReplies: analyticsMetricCardSchema,
    allTimeInteractions: analyticsMetricCardSchema,
  }),
